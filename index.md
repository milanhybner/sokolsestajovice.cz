...
<section class="tiles" id="oddily">
  <article class="style1">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.vsestrannost.dlouhe-url}}/">
      <h2>Všestrannost</h2>
      <div class="content">
  ...
  <article class="style3">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.zalesak.dlouhe-url}}/">
      <h2>Zálesák</h2>
      <div class="content">
  ...
  <article class="style4">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.trampoliny.dlouhe-url}}/">
      <h2>Trampolíny</h2>
      <div class="content">
  ...
  <article class="style5">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.tanec.dlouhe-url}}/">
      <h2>Tanec</h2>
      <div class="content">
  ...
  <article class="style6">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.zeny.dlouhe-url}}/">
  ...
  <article class="style2">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.florbal.dlouhe-url}}/">
      <h2>Florbal</h2>
      <div class="content">
  ...
  <article class="style4">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.zdravotni.dlouhe-url}}/">
  ...
  <article class="style1">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.micovky.dlouhe-url}}/">
      <h2>Míčové hry</h2>
      <div class="content">
  ...
  <article class="style6">
    ...
    <a href="{{ site.baseurl }}{{site.data.oddil.rd.dlouhe-url}}">
      <h2>Rodiče a děti</h2>
      <div class="content">
